...
namespace ConsoleApp
{
   ...
   class Program
   {
        ...
        {
            var q1 = new Question("En iyi programlama dili?", new string[]{"C#","Python","Java","C++"},"C#");
            var q2 = new Question("En popüler programlama dili?", new string[]{"C#","Python","Java","C++"},"C#");
            var q3 = new Question("En çok kazandıran programlama dili?", new string[]{"C#","Python","Java","C++"},"C#");
